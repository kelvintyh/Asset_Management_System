...
Module Module1
    ...
    Function initiateData()
        ...
        user_list.Add(New User("AD0002", "Chung Leong", "Leong", "12345678", "Male", "012-3456519", "leong@gmail.com", GetBinary(My.Resources.login, Nothing), "Admin"))
        user_list.Add(New User("AD0003", "Kelvin Tham", "Kelvin", "12345678", "Male", "011-3456789", "kelvin@gmail.com", GetBinary(My.Resources.login, Nothing), "Admin"))
        user_list.Add(New User("S0001", "Brian Ooi", "Brian", "12345678", "Male", "016-3456789", "brian@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))
        user_list.Add(New User("S0002", "Jeremy Yong", "Jeremy", "12345678", "Male", "012-2242245", "jeremy@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))
        user_list.Add(New User("S0003", "Benz Fong", "Benz", "12345678", "Male", "012-1212454", "benz@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))
        user_list.Add(New User("S0004", "Jacky Chan", "Jacky", "12345678", "Male", "016-3476854", "jacky@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))
        user_list.Add(New User("S0005", "Harley Cheah", "Harley", "12345678", "Male", "012-4368984", "harley@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))
        user_list.Add(New User("S0006", "Jaren Yeap", "Jaren", "12345678", "Male", "012-9875699", "jaren@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))
        user_list.Add(New User("S0007", "Joseph Yeak", "Joseph", "12345678", "Male", "012-9874322", "joseph@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))
        user_list.Add(New User("S0008", "Jun Yan", "JY", "12345678", "Male", "018-2867444", "koh@gmail.com", GetBinary(My.Resources.login, Nothing), "Staff"))

        login_history.Add(New LoginHistory("L0002", "AD0001", "Gregg", "Admin", "2020-04-27 19:42:31"))
        login_history.Add(New LoginHistory("L0003", "AD0001", "Gregg", "Admin", "2020-04-27 19:43:33"))
        login_history.Add(New LoginHistory("L0004", "AD0001", "Gregg", "Admin", "2020-04-27 19:44:35"))
        login_history.Add(New LoginHistory("L0005", "AD0001", "Gregg", "Admin", "2020-04-27 19:45:36"))
        login_history.Add(New LoginHistory("L0006", "AD0001", "Gregg", "Admin", "2020-04-27 20:46:35"))
        login_history.Add(New LoginHistory("L0007", "AD0001", "Gregg", "Admin", "2020-04-27 20:48:31"))
        login_history.Add(New LoginHistory("L0008", "AD0001", "Gregg", "Admin", "2020-04-27 22:50:30"))
        login_history.Add(New LoginHistory("L0009", "AD0001", "Gregg", "Admin", "2020-04-27 23:10:40"))
